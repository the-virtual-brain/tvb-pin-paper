...
Custom tags can also be added by the end-user both on DataTypes and operations, for tracking data inside a TVB Project.
 ...
 \begin{figure*}
 	\centering
	\subfloat[][]{\includegraphics[width=0.59\textwidth]{images/ui_projects.png}}
	\subfloat[][]{\includegraphics[width=0.39\textwidth]{images/ui_project_graph.png}}
	\\
	\subfloat[][]{\includegraphics[width=0.58\textwidth]{images/ui_project_operations.png}}
	\subfloat[][]{\includegraphics[width=0.39\textwidth]{images/ui_project_datatype_details.png}}
...
We do not store or use information about the exact anatomical path or a connection, only the region centers and connection weights and lengths.
 ...
 \begin{figure*}
 	\centering
	\subfloat[][]{\includegraphics[width=0.98\textwidth]{images/ui_connectivity.png}}
	\\
	\subfloat[][]{\includegraphics[width=0.98\textwidth]{images/ui_connectivity_delays.png}}
