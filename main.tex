...
\subsection{Node dynamics}
	...
	(De Groff et al 1993; Omurtag et al 2000; Knight 2000; Gerstner 2000;
	see Deco et al 2008 for review).  The many neurons impart the state
	space with a density, and population density methods describe the
	evolution of this density via the Fokker-Planck (FP) equation (Risken
	1996), comprised of flow and dispersion terms.  This approach assumes
