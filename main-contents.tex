...
Tying together these pieces with
persistent data storage, based on a combination of SQL \& HDF5, is an
system of datatypes modeling neuroscientific data
and the relations among them. These datatypes combine with adapters
