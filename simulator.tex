...
\subsection{Node dynamics}
	...
	\cite{FitzHugh_1961, Nagumo_1962}, so several other mass models are
	...
	Steyn-Ross_1999} are among the available models in TVB.
...
\subsection{Forward solutions}
	...
	elsewhere \cite{Sarvas_1987,Hamalainen_1989,Jirsa_2002,Nolte2003,Gramfort_2010}, TVB provides access
